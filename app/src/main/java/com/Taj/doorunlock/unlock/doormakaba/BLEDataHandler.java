        ...
        do
        {
            ...
            switch (data[offset++])
            {
                case 0:
                    ...
                    errorCode = data[offset] & 0xff;
                    flags = data[offset + 1] & 0xff;
                    messageString = messageString.concat(String.format("%02x", data[offset]));
                ...
                case 2:
                    ...
                    int voltage = (data[offset] & 0xff) << 8;
                    voltage += (data[offset + 1]) & 0xff;
                ...
                case 3:
                    ...
                    systemType = data[offset] & 0xff;
                    lockModel = data[offset + 1] & 0xff;
                    messageString = messageString.concat(String.format("%02x", data[offset]));
                    messageString = messageString.concat(String.format("%02x\n", data[offset+1]));
                    offset += length3;
                    break;
