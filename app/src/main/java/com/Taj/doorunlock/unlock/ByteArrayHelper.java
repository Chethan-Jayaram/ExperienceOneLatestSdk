...
public class ByteArrayHelper {
  ...
  /*  public static ReaderBatteryStatus ReaderBatteryStatus(byte[] payload) {
    ...
    public static String FirmwareVersionLCU(byte[] payload) {
        ...
        String resMajor = hexStringToDecString(result.substring(0, 2));
        String resMinor = hexStringToDecString(result.substring(2, 4));
        String resRevision = hexStringToDecString(result.substring(4, 6));
        String resBuild = hexStringToDecString(result.substring(6, 8));
    ...
    public static String hexStringToDecString(String hexValue){
