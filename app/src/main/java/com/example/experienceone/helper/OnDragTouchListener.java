...
public class OnDragTouchListener implements View.OnTouchListener {
    ...
    public interface OnDragActionListener {
         ...
         * @param view The view dragged
         */
        void onDragEnd(View view,Boolean max);
    }
          ...
          bounds = new float[4];
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if(((v.getWidth()+bounds[0])*100/maxRight)>=100) {
                        hasReachedMax=true;
                    }
    ...
    private void onDragFinish() {
        ...
        dY = 0;
        isDragging = false;
        if (mOnDragActionListener != null && hasReachedMax) {
            mOnDragActionListener.onDragEnd(mView,hasReachedMax);
        }else{
            mView.animate().x(0).y(0).setDuration(0).start();
        }
